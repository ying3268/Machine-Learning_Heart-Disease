...
(X_new, y, test_size=0.2, train_size=0.8, random_state=0)
...
print " Possibility of belonging to Class 2 is", float(count2)/total
print " Possibility of belonging to Class 3 is", float(count3)/total
print " Possibility of belonging to Class 4 is", float(count4)/total
